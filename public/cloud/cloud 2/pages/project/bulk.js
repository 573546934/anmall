...
const area = {
    ...
    value: [
        ...
        { name: '300以下', value: { area_min: 0, area_max: 300 } },
        { name: '300-500', value: { area_min: 300, area_max: 500 } },
        { name: '500-800', value: { area_min: 500, area_max: 800 } },
        { name: '800-100', value: { area_min: 800, area_max: 1000 } }
    ]
};
let filtersBackUp;
let clearFilter;
...
Page({
    ...
    initData(loading, flag, page_num) {
        return new Promise(resolve => {
            ...
            let url = `articles?limit=10&category_id=6&page=${page_num}`,
