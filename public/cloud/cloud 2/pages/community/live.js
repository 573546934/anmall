...
Page({
    ...
    data: {
        tabs: [
            { label: '精彩推荐',category: '精彩推荐', list: [], last_page: null, page_num: 1, limit: 10 },
            { label: '已预约',category: '已预约', list: [], last_page: null, page_num: 1, limit: 10 },
            { label: '往期视频',category: '往期视频', list: [], last_page: null, page_num: 1, limit: 10 },
        ],
        tab: 0,
