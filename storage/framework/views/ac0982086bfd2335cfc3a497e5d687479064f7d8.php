    ...
    <div class="layui-card">
            ...
            <div class="layui-input-inline">
                <select name="category_id"  id="mark">
                    ...
                    <?php $__currentLoopData = $marks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($mark['mark']); ?>" ><?php echo e($mark['mark_name']); ?></option>
        ...
        <div class="layui-card-body">
            <div class="layui-btn-group">
                <a class="layui-btn layui-btn-sm" href="<?php echo e(route('admin.dictionary.create')); ?>">添 加</a>
            </div>
...
<?php $__env->startSection('script'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('config.dictionary')): ?>
        <script>
                ...
                table.on('tool(dataTable)', function(obj){ //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if(layEvent === 'del'){
                        layer.confirm('确认删除吗？', function(index){
                            $.post("<?php echo e(route('admin.dictionary.destroy')); ?>",{_method:'delete',ids:data.id},function (result) {
                                if (result.code==0){
