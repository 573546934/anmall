        ...
        <div class="layui-card-header layuiadmin-card-header-auto">
            ...
            <div class="layui-form" >
                <div class="layui-input-inline">
                    <input type="text" name="company_name" id="company_name" placeholder="请输入资方名称" class="layui-input">
                </div>
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="id_pos">
             ...
             <script type="text/html" id="id_rev">
                ...
                无图片
                {{#  } else { }}
                <a href="{{d.id_rev.url}}" target="_blank" title="点击查看"><img src="{{d.id_rev.url}}" alt=""  height="45"></a>
                {{# } }}
            </script>
             <script type="text/html" id="avatarimg">
                ...
                无图片
                {{#  } else { }}
                <a href="{{d.avatarimg.url}}" target="_blank" title="点击查看"><img src="{{d.avatarimg.url}}" alt=""  height="45"></a>
                {{# } }}
            </script>
        ...
        <script>
            layui.use(['layer','table','form'],function () {
                ...
                var dataTable = table.render({
                    ...
                    ,url: "<?php echo e(route('admin.manager.data')); ?>" //数据接口
                    ,page: true //开启分页
                    ,cols: [[ //表头
                        ...
                        ,{field: 'id_num', title: '身份证号码',width:100}
                        ,{field: 'sex', title: '性别',width:80}
                        ,{field: 'city', title: '城市',width:80}
                        ,{field: 'phone', title: '联系方式',toolbar:'#phone',width:80}
                        ,{field: 'email', title: '邮箱',width:100}
                        ,{field: 'avatar', title: '头像',toolbar:'#avatarimg',width:80}
                ...
                table.on('tool(dataTable)', function(obj){ //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if(layEvent === 'del'){
                        layer.confirm('确认删除吗？', function(index){
                            $.post("<?php echo e(route('admin.manager.destroy')); ?>",{_method:'delete',ids:[data.id]},function (result) {
                                if (result.code==0){
                        ...
                        location.href = '/admin/manager/'+data.id+'/edit';
                        ...
                        layer.confirm('确认审核？', {
                            ...
                            $.post("<?php echo e(route('admin.manager.by')); ?>",{_method:'put',ids:[data.id]},function (result) {
                                if(result.code == 0){
                                    dataTable.reload()
                            ...
                            $.post("<?php echo e(route('admin.manager.refuse')); ?>",{_method:'put',ids:[data.id]},function (result) {
                                if(result.code == 0){
                                    dataTable.reload()
                                    layer.msg(result.msg,{icon:6})
                                }else{
                ...
                $("#listDelete").click(function () {
                    ...
                    if (ids.length>0){
                        layer.confirm('确认删除吗？', function(index){
                            $.post("<?php echo e(route('admin.manager.destroy')); ?>",{_method:'delete',ids:ids},function (result) {
                                if (result.code==0){
                                    dataTable.reload()
                                }
                                layer.close(index);
                ...
                $("#listBy").click(function () {
                    ...
                    if (ids.length>0){
                        layer.confirm('确认审核？', {
                            ...
                            $.post("<?php echo e(route('admin.manager.by')); ?>",{_method:'put',ids:ids},function (result) {
                                if(result.code == 0){
                                    dataTable.reload()
                                    layer.msg(result.msg,{icon:6})
                                }else{
                            ...
                            $.post("<?php echo e(route('admin.manager.refuse')); ?>",{_method:'put',ids:ids},function (result) {
                                if(result.code == 0){
                                    dataTable.reload()
                                    layer.msg(result.msg,{icon:6})
                                }else{
